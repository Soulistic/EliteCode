...
const  ResetPassword:React.FC<ResetPasswordProps> = () => {
    ...
    return (<form className='space-y-6 px-6 py-4' onSubmit={handleReset}>
    ...
    <div>
        ...
        <input type="email" name="email" id="email" placeholder='name@company.com' onChange={(e)=>setEmail(e.target.value)} className='border-2 outline-none sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-600 border-gray-500 placeholder-gray-500 text-white'></input>
    </div>
