...
const Topbar:React.FC<TopbarProps> = ({problemPage}) => {
    ...
    return(
        <nav className='relative flex h-[50px] w-full shrink-0 justify-center items-center bg-dark-layer-1 text-dark-gray-7'>
            <div className={`flex w-full items-lef justify-between ${problemPage?"max-w-[1200px] mx-auto" : ""}`}>
